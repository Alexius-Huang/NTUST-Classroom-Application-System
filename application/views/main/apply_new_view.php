<title>申請借用 - 學生活動大樓教室借用系統</title>
<section class="content-header">
  <h1>申請借用</h1>
  <ol class="breadcrumb">
    <li><a href="/zh-tw">學生活動大樓教室借用系統</a></li>
    <li class="active"><a href="<?php echo base_url(); ?>main/apply_new">申請借用</a></li>
  </ol>
</section>
    ...
    <div class="col-md-12">
      <form id="form_apply" role="form">
        ...
        <div class="box box-primary">
          ...
          <?php $this->load->view('main/js/apply_new_js'); ?>
        </div>
      </form>
    </div>
  </div>
